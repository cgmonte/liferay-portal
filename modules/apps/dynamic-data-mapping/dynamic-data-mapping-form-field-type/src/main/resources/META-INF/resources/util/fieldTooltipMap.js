...
const INPUT_MASK_FORMAT_STRING = Liferay.Language.get('input-mask-format');
...
const fieldTooltipMap = {
	HTMLAutocompleteAttribute: {
		...
		header: INPUT_MASK_FORMAT_STRING,
		hideOnTriggerOut: true,
		image: {
			alt: INPUT_MASK_FORMAT_STRING,
			height: 170,
	...
	inputMaskFormat: {
		...
		content: sub(
			Liferay.Language.get(
				'set-the-x-for-this-field-this-informs-the-browser-about-the-type-of-data-it-stores'
			),
...
export default fieldTooltipMap;
