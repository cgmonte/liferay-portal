...
public class DDMFormFieldTemplateContextContributorUtilTest
	...
	public void testGetLocalesMap() {
		...
		Assert.assertEquals("en_US", defaultLocaleJSONObject.get("localeId"));
		Assert.assertEquals("en_US", editingLocaleJSONObject.get("localeId"));
	}
