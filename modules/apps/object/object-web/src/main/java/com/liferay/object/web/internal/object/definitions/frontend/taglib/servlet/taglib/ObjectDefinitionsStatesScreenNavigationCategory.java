...
import com.liferay.object.web.internal.object.definitions.display.context.ObjectDefinitionsStatesDisplayContext;
...
public class ObjectDefinitionsStatesScreenNavigationCategory
	...
	public String getEntryKey() {
		return ObjectDefinitionsScreenNavigationEntryConstants.ENTRY_KEY_STATES;
	}
	...
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "state-manager");
	}
	...
	public void render(
		...
		httpServletRequest.setAttribute(
			...
			new ObjectDefinitionsStatesDisplayContext(
