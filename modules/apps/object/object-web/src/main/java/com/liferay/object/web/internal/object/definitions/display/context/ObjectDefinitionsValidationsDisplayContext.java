...
public class ObjectDefinitionsValidationsDisplayContext {
	...
	public String getAPIURL() {
		return "/o/object-admin/v1.0/object-definitions/" +
			getObjectDefinitionId() + "/object-validations";
	}
	...
	public List<FDSActionDropdownItem> getFDSActionDropdownItems()
		...
		return Arrays.asList(
			new FDSActionDropdownItem(
				...
				"get", null, "sidePanel"),
			new FDSActionDropdownItem(
				"/o/object-admin/v1.0/object-validations/{id}", "trash",
				"delete",
	...
	public List<Map<String, String>> getObjectValidationsValidationTypeMaps() {
