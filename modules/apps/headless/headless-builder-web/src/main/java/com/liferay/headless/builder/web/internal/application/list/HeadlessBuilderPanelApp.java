...
package com.liferay.headless.builder.web.internal.application.list;
...
public class HeadlessBuilderPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return HeadlessBuilderWebPortletKeys.HEADLESS_BUILDER_WEB;
	}
	...
	@Reference(
		target = "(javax.portlet.name=" + HeadlessBuilderWebPortletKeys.HEADLESS_BUILDER_WEB + ")"
	)
