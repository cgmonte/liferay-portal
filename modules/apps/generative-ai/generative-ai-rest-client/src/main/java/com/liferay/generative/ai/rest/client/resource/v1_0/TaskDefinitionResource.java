...
package com.liferay.generative.ai.rest.client.resource.v1_0;
...
import com.liferay.generative.ai.rest.client.problem.Problem;
...
public interface TaskDefinitionResource {
	...
	public HttpInvoker.HttpResponse postTaskDefinitionHttpResponse(
			TaskDefinition taskDefinition)
		throws Exception;

	public void postTaskDefinitionBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postTaskDefinitionBatchHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getTaskDefinitionByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putTaskDefinitionByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, TaskDefinition taskDefinition)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postTaskDefinitionValidateHttpResponse(
			String string)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getTaskDefinitionHttpResponse(
			Long taskDefinitionId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchTaskDefinitionHttpResponse(
			Long taskDefinitionId, TaskDefinition taskDefinition)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putTaskDefinitionHttpResponse(
			Long taskDefinitionId, TaskDefinition taskDefinition)
		throws Exception;

	public void putTaskDefinitionBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse putTaskDefinitionBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public void getTaskDefinitionExport(Long taskDefinitionId) throws Exception;

	public HttpInvoker.HttpResponse getTaskDefinitionExportHttpResponse(
			Long taskDefinitionId)
		throws Exception;
	...
	public static class TaskDefinitionResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/export-batch");
		...
		public TaskDefinition postTaskDefinition(TaskDefinition taskDefinition)
			...
			HttpInvoker.HttpResponse httpResponse =
				postTaskDefinitionHttpResponse(taskDefinition);
		...
		public HttpInvoker.HttpResponse postTaskDefinitionHttpResponse(
			...
			httpInvoker.body(taskDefinition.toString(), "application/json");
		...
		public void postTaskDefinitionBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postTaskDefinitionBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse postTaskDefinitionBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/by-external-reference-code/{externalReferenceCode}");
		...
		public TaskDefinition postTaskDefinitionValidate(String string)
			...
			HttpInvoker.HttpResponse httpResponse =
				postTaskDefinitionValidateHttpResponse(string);
		...
		public HttpInvoker.HttpResponse postTaskDefinitionValidateHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/validate");
		...
		public TaskDefinition getTaskDefinition(Long taskDefinitionId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getTaskDefinitionHttpResponse(taskDefinitionId);
		...
		public TaskDefinition patchTaskDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchTaskDefinitionHttpResponse(
		...
		public TaskDefinition putTaskDefinition(
			...
			HttpInvoker.HttpResponse httpResponse =
				putTaskDefinitionHttpResponse(taskDefinitionId, taskDefinition);
		...
		public void putTaskDefinitionBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				putTaskDefinitionBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse postTaskDefinitionCopyHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/{taskDefinitionId}/copy");
		...
		public void getTaskDefinitionExport(Long taskDefinitionId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getTaskDefinitionExportHttpResponse(taskDefinitionId);
		...
		public HttpInvoker.HttpResponse getTaskDefinitionExportHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/generative-ai/v1.0/task-definitions/{taskDefinitionId}/export");
