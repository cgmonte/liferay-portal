...
public abstract class BaseGenerativeAIResponseResourceImpl
	implements GenerativeAIResponseResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/generative-ai/v1.0/generate/{externalReferenceCode}' -d $'{"input": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseGenerativeAIResponseResourceImpl.class);
