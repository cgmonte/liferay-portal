 ...
 */
public class AITaskDefinitionTools {

	@Tool("The 'AI Task Definition Tool' to create a new AI task definition")
	TaskDefinition createTaskDefinition(
		@P("The configuration of the AI task definition as a JSON string") String configurationJSON,
		@P("The title of the AI task definition to be created") String title,
		@P("The description of the AI task definition to be created") String description,
		@P("The unique code name of the AI task definition to be created") String externalReferenceCode) {

		ServiceContext serviceContext =
			ServiceContextThreadLocal.getServiceContext();

		configurationJSON =
			configurationJSON.replace("[user_input]", "{{text}}");
	...
	private static final Log _log =
		LogFactoryUtil.getLog(AITaskDefinitionTools.class);
}
