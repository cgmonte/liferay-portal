...
package com.liferay.portal.workflow.kaleo.designer.web.internal.util.client.extension;
...
public class ClientExtensionHelperTest {
	...
	public void testGetClientExtensionsJSONArray() throws Exception {
		JSONObject clientExtensionJSONObject = _findClientExtension(
			_clientExtensionHelper.getClientExtensionsJSONArray(), key);
	...
	protected static void setUpClientExtensionHelper() {
		ReflectionTestUtil.setFieldValue(
			_clientExtensionHelper, "_serviceTrackerMap", _serviceTrackerMap);
	}
	...
	private static final ClientExtensionHelper _clientExtensionHelper =
		new ClientExtensionHelper();
		...
		_clientExtensionPropertiesMap =
			HashMapBuilder.<String, Map<String, Object>>put(
				...
				HashMapBuilder.<String, Object>put(
					ClientExtensionHelper.ACTION_EXECUTOR_LANGUAGE_KEY,
					"function#client-extension-1"
				).put(
